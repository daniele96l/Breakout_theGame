...
public class CommandPlayer {
    ...
    public void Move()
    {
         if(Gdx.input.isKeyPressed(Input.Keys.LEFT)){
            if(paddle.getPosition().x > Info.offset) { //controllo il range in cui la Paddle si può muovere
            ...
            if(paddle.getPosition().x < 800 - paddle.getWidth()*Info.paddleresize -Info.offset) {
